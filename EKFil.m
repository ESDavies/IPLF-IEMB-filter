function [squared_gospa_t_tot,squared_gospa_loc_t_tot,squared_gospa_mis_t_tot,squared_gospa_false_t_tot] = EKFil(X_truth,z,m_b,t_birth,t_death,P_ini,p_s_constant,Cells,cell_width,n,F,Q,R,Nsteps,sensor_pos,sensor_index,sensor_num)
