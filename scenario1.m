%This function runs scenario 1 for all the Gaussian multi-target filters in
...
%This scenario considers a Bernoulli birth model with large spatial
%uncertainty
...
writematrix([...
    ...
    ],'Results TableBB.csv',"WriteMode","append");

% b=["total" "localisation" "false" "missed"];
% for i=1:4
%     saveas(figure(i),'GraphsBB\'+b(i)+'.fig')
%     saveas(figure(i),'GraphsBB\'+b(i)+'.png')
%     saveas(figure(i),'GraphsBB\'+b(i)+'.pdf','pdf')
%     saveas(figure(i),'GraphsBB\'+b(i)+'.esp','epsc')
% end